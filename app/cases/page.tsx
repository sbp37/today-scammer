...
export default function CasesPage() {
  return (
    <InfoPage
      ...
      eyebrow="CASE FILES"
      title="사건 해설"
      summary="게임에서 만나는 사기꾼들이 실제로 어떤 수법을 쓰는지 사건별로 풀어 썼습니다. 플레이 전에 읽어도 되고, 당하고 나서 읽어도 됩니다. 후자가 더 잘 남습니다."
    >
      <section>
        <h2>왜 해설을 따로 두었나</h2>
        <p>게임 안에서는 설명을 최대한 줄였습니다. 교육 앱처럼 정답을 알려주면 상황극이 무너지기 때문입니다. 대신 대화가 끝난 뒤에 &ldquo;그래서 저게 뭐였지&rdquo; 하고 찾아볼 곳이 필요했고, 이 페이지가 그 자리입니다.</p>
