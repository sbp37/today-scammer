  ...
  return (
    <InfoPage current="/privacy" eyebrow="PRIVACY FILE" title="개인정보처리방침" summary="오늘의 사기꾼은 회원가입 없이 플레이할 수 있으며, 게임 속 답변에 실제 개인정보를 입력받지 않습니다.">
      <section>
        ...
        <p>이용 현황을 파악하기 위해 서비스 자체 서버에 방문, 사건 시작, 사건 완료와 같은 이벤트와 유입 경로를 집계합니다. 대화 내용, 사용자가 고른 답변, 결과 점수는 전송되지 않습니다. 중복 방문을 구분할 때도 접속 정보와 임시 세션 값을 결합해 만든 축약 문자열만 사용하며 IP 주소 원본은 저장하지 않습니다. 이 통계는 날짜별 합계 형태로만 보관됩니다.</p>
      </section>
      <section>
        <h2>2. 기기에 저장되는 정보</h2>
